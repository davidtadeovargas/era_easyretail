...
public class PartprevcomprsTmpsValidatorsExceptions {

   private static PartprevcomprsTmpsValidatorsExceptions PartprevcomprsTmpsValidatorsExceptions;

   public static PartprevcomprsTmpsValidatorsExceptions getSigleton(){
       if(PartprevcomprsTmpsValidatorsExceptions==null){PartprevcomprsTmpsValidatorsExceptions = new PartprevcomprsTmpsValidatorsExceptions();}return PartprevcomprsTmpsValidatorsExceptions;
   }
