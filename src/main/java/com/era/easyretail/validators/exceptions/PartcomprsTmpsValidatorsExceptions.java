...
public class PartcomprsTmpsValidatorsExceptions {

   private static PartcomprsTmpsValidatorsExceptions PartcomprsTmpsValidatorsExceptions;

   public static PartcomprsTmpsValidatorsExceptions getSigleton(){
       if(PartcomprsTmpsValidatorsExceptions==null){PartcomprsTmpsValidatorsExceptions = new PartcomprsTmpsValidatorsExceptions();}return PartcomprsTmpsValidatorsExceptions;
   }
