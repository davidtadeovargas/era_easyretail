...
public class UserPermissionsValidatorsExceptions {

   private static UserPermissionsValidatorsExceptions UserPermissionsValidatorsExceptions;

   public static UserPermissionsValidatorsExceptions getSigleton(){
       if(UserPermissionsValidatorsExceptions==null){UserPermissionsValidatorsExceptions = new UserPermissionsValidatorsExceptions();}return UserPermissionsValidatorsExceptions;
   }
   ...
   public Exception getPermisoRepararErroresException(){
       return new Exception("Falta espeficiar PermisoRepararErrores");
   }
   ...
   public Exception getUserIDException(){
       return new Exception("Falta espeficiar UserID");
   }
