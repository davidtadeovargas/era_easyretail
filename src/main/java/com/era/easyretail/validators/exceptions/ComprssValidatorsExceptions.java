...
public class ComprssValidatorsExceptions {

   private static ComprssValidatorsExceptions ComprssValidatorsExceptions;

   public static ComprssValidatorsExceptions getSigleton(){
       if(ComprssValidatorsExceptions==null){ComprssValidatorsExceptions = new ComprssValidatorsExceptions();}return ComprssValidatorsExceptions;
   }
