...
import com.era.views.DatsCartaPorJFrame;
...
public class DatsCartaPorViewController extends DatsCartaPorJFrame {
    ...
    public DatsCartaPorViewController() {
        ...
        try{
            ...
            LoggerUtility.getSingleton().logError(DatsCartaPorViewController.class, ex);
            try {
                DialogsFactory.getSingleton().getExceptionDialog(baseJFrame, ex).show();
            } catch (Exception ex1) {
                Logger.getLogger(DatsCartaPorViewController.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
