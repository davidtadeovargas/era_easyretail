...
public class ConceptosPagoViewController extends ConceptosPagoJFrame{
    ...
    public ConceptosPagoViewController() {
        ...
        try{
            ...
            LoggerUtility.getSingleton().logError(ConceptosPagoViewController.class, ex);
            try {
                DialogsFactory.getSingleton().getExceptionDialog(baseJFrame, ex).show();
            } catch (Exception ex1) {
                Logger.getLogger(ConceptosPagoViewController.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
