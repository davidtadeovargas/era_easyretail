...
import com.era.views.BuscCompJFrame;
...
public class BuscCompViewController extends BuscCompJFrame{
    ...
    public BuscCompViewController() {
        ...
        try{
            ...
            LoggerUtility.getSingleton().logError(BuscCompViewController.class, ex);
            try {
                DialogsFactory.getSingleton().getExceptionDialog(baseJFrame, ex).show();
            } catch (Exception ex1) {
                Logger.getLogger(BuscCompViewController.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
