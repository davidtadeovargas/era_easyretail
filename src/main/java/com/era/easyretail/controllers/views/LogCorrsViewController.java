...
import com.era.views.LogCorrsJFrame;
...
public class LogCorrsViewController extends LogCorrsJFrame {
    ...
    public LogCorrsViewController() {
        ...
        try{
            ...
            jBRep.addActionListener((java.awt.event.ActionEvent evt) -> {
                jBRepActionPerformed(evt);
            });
            
        }catch (Exception ex) {
            LoggerUtility.getSingleton().logError(LogCorrsViewController.class, ex);
            try {
                DialogsFactory.getSingleton().getExceptionDialog(baseJFrame, ex).show();
            } catch (Exception ex1) {
                Logger.getLogger(LogCorrsViewController.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
    ...
    private void jBRepActionPerformed(java.awt.event.ActionEvent evt) {                                             
