...
public class VerCtaContViewController extends VerCtaContJFrame {
    ...
    public VerCtaContViewController() {
        ...
        try{
            ...
            jBPag.addActionListener((java.awt.event.ActionEvent evt) -> {
                jBPagActionPerformed(evt);
            });
            
        }catch (Exception ex) {
            LoggerUtility.getSingleton().logError(VerCtaContViewController.class, ex);
            try {
                DialogsFactory.getSingleton().getExceptionDialog(baseJFrame, ex).show();
            } catch (Exception ex1) {
                Logger.getLogger(VerCtaContViewController.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
