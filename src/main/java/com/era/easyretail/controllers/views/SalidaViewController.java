...
import com.era.views.SalidaJFrame;
...
public class SalidaViewController extends SalidaJFrame {
    ...
    public SalidaViewController() {
        ...
        try{
            ...
            LoggerUtility.getSingleton().logError(SalidaViewController.class, ex);
            try {
                DialogsFactory.getSingleton().getExceptionDialog(baseJFrame, ex).show();
            } catch (Exception ex1) {
                Logger.getLogger(SalidaViewController.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
