...
INSERT INTO `mons` (`c_moneda_id`, `c_Moneda`, `Descripcion`, `Decimales`, `Porcentaje_variación`, `Fecha_inicio_de_vigencia`,`falt`,`fmod`,`simb`, `mn`,`val`) VALUES
(100, 'MXN', 'Peso Mexicano', '2', 500, '2017-08-14 00:00:00', now(),now(),'$',1,1);
